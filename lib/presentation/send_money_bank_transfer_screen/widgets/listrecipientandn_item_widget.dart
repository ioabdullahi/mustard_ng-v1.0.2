...
import '../models/listrecipientandn_item_model.dart';
import 'package:flutter/material.dart';
import 'package:mustard_ng/core/app_export.dart';

// ignore: must_be_immutable
class ListrecipientandnItemWidget extends StatelessWidget {
  ListrecipientandnItemWidget(this.listrecipientandnItemModelObj);

  ListrecipientandnItemModel listrecipientandnItemModelObj;

  var controller = Get.find<SendMoneyBankTransferController>();
