...
import '../models/listrecipientandn1_item_model.dart';
import 'package:flutter/material.dart';
import 'package:mustard_ng/core/app_export.dart';

// ignore: must_be_immutable
class Listrecipientandn1ItemWidget extends StatelessWidget {
  Listrecipientandn1ItemWidget(this.listrecipientandn1ItemModelObj);

  Listrecipientandn1ItemModel listrecipientandn1ItemModelObj;

  var controller = Get.find<SendMoneyMustardTagChooseWalletController>();
