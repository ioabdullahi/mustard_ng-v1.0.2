...
import '../models/saving_plan_item_model.dart';
import 'package:flutter/material.dart';
import 'package:mustard_ng/core/app_export.dart';

// ignore: must_be_immutable
class SavingPlanItemWidget extends StatelessWidget {
  SavingPlanItemWidget(this.savingPlanItemModelObj);

  SavingPlanItemModel savingPlanItemModelObj;

  var controller = Get.find<SavingPlanController>();
