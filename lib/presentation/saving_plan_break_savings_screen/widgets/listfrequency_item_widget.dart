...
import '../models/listfrequency_item_model.dart';
import 'package:flutter/material.dart';
import 'package:mustard_ng/core/app_export.dart';

// ignore: must_be_immutable
class ListfrequencyItemWidget extends StatelessWidget {
  ListfrequencyItemWidget(this.listfrequencyItemModelObj);

  ListfrequencyItemModel listfrequencyItemModelObj;

  var controller = Get.find<SavingPlanBreakSavingsController>();
