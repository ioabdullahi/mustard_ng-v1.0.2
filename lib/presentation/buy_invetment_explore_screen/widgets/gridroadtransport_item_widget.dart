...
import '../models/gridroadtransport_item_model.dart';
import 'package:flutter/material.dart';
import 'package:mustard_ng/core/app_export.dart';

// ignore: must_be_immutable
class GridroadtransportItemWidget extends StatelessWidget {
  GridroadtransportItemWidget(this.gridroadtransportItemModelObj);

  GridroadtransportItemModel gridroadtransportItemModelObj;

  var controller = Get.find<BuyInvetmentExploreController>();
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        overflow: TextOverflow.ellipsis,
                        textAlign: TextAlign.left,
                        style: AppStyle.txtLatoSemiBold10Deeporange901.copyWith(
                          height: 1.00,
                        ),
                      ),
                    ),
