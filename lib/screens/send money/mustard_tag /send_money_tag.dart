...
class SendMoneyMustardTag extends StatefulWidget {
  final String email;
  const SendMoneyMustardTag({
    Key? key,
    required this.email,
  }) : super(key: key);

  @override
  State<SendMoneyMustardTag> createState() => _SendMoneyMustardTagState();
}

class _SendMoneyMustardTagState extends State<SendMoneyMustardTag> {
  String? _wallettype;
  int? selectedIndex;
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return beneficiaries(
                                name: 'Nonsa', initial: 'NN', tag: 'MN56');
                          }),
                    ),
                  ],
                ),
